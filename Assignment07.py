...
#   DBriggs,5/29/25,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
#FILE_NAME: str = "Enrollments1.json"
...
Changelog:
-DBriggs, 5,29,25, Created Person Class.
"""
...
# TODO Create a getter and setter for the first_name property
    ...
    def first_name(self, value: str):
        if value.isalpha() or value == "":  # is a character or empty string
...
class Student(Person):
    ...
    DBriggs, 5/29/2025, Created Student Class
    """
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        DBriggs, 5/29/25, Created function
